...
define(['/assets/js/logger/logger.js', '/assets/js/utils/lodash.js', '/assets/js/utils/objects.js', '/assets/js/utils/promise.js'], function (Logger, _, ObjectUtil, Promise) {
